...
export default function AdminLandPage() {
    ...
    return (
        <div className="space-y-8">
            ...
            {/* Header */}
            <div>
                <h1 className="text-2xl font-bold text-slate-900">Land & Thram Records</h1>
                <p className="text-sm text-slate-500">
                    Manage land details and valuation used in the demo token generation.
                </p>
            </div>
            ...
            >
                <h2 className="text-lg font-semibold text-slate-700">Add New Land Record</h2>

                <div className="grid md:grid-cols-3 gap-4">
                    {/* Thram ID */}
                    <div className="space-y-1">
                        <label className="text-sm font-medium text-slate-600">Thram ID</label>
                        <input
                    ...
                    {/* Plot ID */}
                    <div className="space-y-1">
                        <label className="text-sm font-medium text-slate-600">Plot ID</label>
                        <input
                            className="w-full px-3 py-2 rounded-md border border-slate-300 bg-white text-slate-800 text-sm shadow-sm focus:ring-2 focus:ring-slate-400 focus:outline-none"
                            placeholder="PLOT-xxx"
                            name="plotId"
                            value={form.plotId}
                            onChange={handleChange}
                        />
                    ...
                    {/* Area (sqm) */}
                    <div className="space-y-1">
                        <label className="text-sm font-medium text-slate-600">Area (sq.m)</label>
                        <input
                            type="number"
                            className="w-full px-3 py-2 rounded-md border border-slate-300 bg-white text-slate-800 text-sm shadow-sm focus:ring-2 focus:ring-slate-400 focus:outline-none"
                            name="areaSqm"
                    ...
                    {/* Valuation */}
                    <div className="space-y-1">
                        <label className="text-sm font-medium text-slate-600">Valuation (BTN)</label>
                        <input
                            type="number"
                            className="w-full px-3 py-2 rounded-md border border-slate-300 bg-white text-slate-800 text-sm shadow-sm focus:ring-2 focus:ring-slate-400 focus:outline-none"
                            name="valuationBtn"
            ...
            <div className="rounded-xl bg-white border border-slate-200 p-6 shadow-sm">
                <h2 className="text-lg font-semibold text-slate-700 mb-4">Land Records</h2>
